#+:tsdb
(in-package :tsdb)
;;  (lkb::lkb-load-lisp "/home/bond/delphin/grammars/japanese/lkb/"
"patches.lsp")
    ...
    ;(setf (stream-external-format stream) (excl:find-external-format :utf-8))
      ...
      when results do
        ...
        (multiple-value-bind (stream foo pid)
          ...
          (format stream  "<meta>~%")
          (format stream  "<meta http-equiv=\"Content-Type\"
content=\"text/html ; charset=utf8\">~%")
          (format stream  "<link TYPE=\"text/css\" REL=\"stylesheet\"
HREF=\"lkb.css\">~%")
          (format stream  "<script SRC=\"lkb.js\" LANGUAGE=\"javascript\"
